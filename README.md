...
> This project was inspired by Greg Reda, with the objective of adapting cohort analysis workflows to the context of Elasticsearch and the eland library.

Despite performing these analyses frequently, I find it helpful to document the step-by-step process for building cohort models with Python and pandas. This repository serves as a reference for implementing these workflows, specifically when working with Elasticsearch data.

I will start by walking through what cohort analysis is and why it is commonly used in startups and other growth businesses. Then, we will create one from a standard purchase dataset.
...
It is common for cohorts to be created based on a customer's first usage of the platform, where "usage" is dependent on your business's key metrics. For Uber or Lyft, usage would be booking a trip through one of their apps. For GrubHub, it is ordering some food. For AirBnB, it is booking a stay.
...
When building a cohort analysis, it is important to consider the relationship between the event or interaction you are tracking and its relationship to your business model.

## Why is it valuable?

Cohort analysis can be helpful when it comes to understanding your business's health and "stickiness" - the loyalty of your customers. Stickiness is critical since it is far cheaper and easier to keep a current customer than to acquire a new one. For startups, it is also a key indicator of product-market fit.
...
It is also a good way to visualize your user retention/churn as well as formulating a basic understanding of their lifetime value.
...
**Pranav Grover**
Data Analyst | MS in Business Analytics and AI (UT Dallas)

Pranav is a results-driven Data Analyst with experience engineering ETL pipelines and building scalable dashboards. He specializes in translating large-scale data into actionable insights using SQL, Python, and tools like Power BI and Tableau.

- **Email**: pranavg0520@outlook.com
- **LinkedIn**: [linkedin.com/in/pranav-grover-utd](https://linkedin.com/in/pranav-grover-utd)
- **Skills**: SQL, Python, R, Scikit-learn, Snowflake